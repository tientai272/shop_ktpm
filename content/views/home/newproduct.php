							...
							<li class="col-sm-3 col-xs-12 product">
								...
								<span class="product-thumb-info">
									...
									<a href="product/<?php echo $new_product['id']; ?>-<?php echo $new_product['slug']; ?>">
										<span class="product-thumb-info-image">
											<span class="product-thumb-info-act">
												<span class="product-thumb-info-act-left"><em>Lượt xem: <?php echo $new_product['totalView']; ?></em></span>
									...
									<span class="product-thumb-info-content">
										<a href="product/<?php echo $new_product['id']; ?>-<?php echo $new_product['slug']; ?>/">
											<h4 title="<?php echo $new_product['product_name']; ?>"><?php if (strlen($new_product['product_name']) > 20) echo substr($new_product['product_name'], 0, 20) . '...';
