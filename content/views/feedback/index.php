...
<div role="main" class="main shop">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="shorter"><strong>Gửi phản hồi của bạn đến shop</strong></h2>
                <?php if (isset($user_nav)) echo '<p style="color: black">Bạn đang đăng nhập với người dùng: <a href="admin.php?controller=user&action=info&user_id=' . $user_nav . '"><b>' . $user_action['user_name'] . '</b></a></p>';
