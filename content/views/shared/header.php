...
<head>
	...
	<meta charset="utf-8">
	<title><?php echo isset($title) ? $title : 'Shop KTPM'; ?></title>
				...
				<div class="logo">
					<a href="home">
						<?php if (isset($link_logo)) : ?>
							<img alt="Porto" width="160" height="105" data-sticky-width="82" data-sticky-height="40" src="public/img/<?= $link_logo ?>"><?php endif; ?>
					</a>
				</div>
				<nav>
				...
				<div class="container">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main" id="mainMenu">
							<li class="dropdown">
								<a style="color: black" class="dropdown-toggle" href="index.php">
									Trang Chủ
							...
							<?php foreach ($ccategories as $ccategory) : ?>
								<li class="dropdown">
									<a style="color: black" class="dropdown-toggle" href="shop/<?php echo $ccategory['id'] ?>-<?php echo $ccategory['slug'] ?>">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="signin-form">
															<span style="color: white" class="mega-menu-sub-title">Đăng nhập tài khoản</span>
							...
							<?php else : ?>
								<li class="dropdown mega-menu-item mega-menu-signin signin logged" id="headerAccount">
									<a class="dropdown-toggle" href="admin.php">
										...
										else echo $user_login['user_username'] ?>
										<i class="fa fa-angle-down"></i>
<!--										'<img style="max-width: 25px;  border-radius: 15px 15px 15px 15px;" src="public/upload/images/' . $user_login['user_avatar'] . '" alt="' . $user_login['user_name'] . '">'; ?>-->
									</a>
									<ul class="dropdown-menu">
										<li>
											<div class="mega-menu-content">
															...
															<?php foreach ($cart as $product_id => $product_cart) { ?>
																<tr>
																	<td class="product-thumbnail">
																		<a  style="color: white;"  href="product/<?php echo $product_cart['id'] . '-' . slug($product_cart['name']); ?>">
																	...
																	<td class="product-name">
																		<a  style="color: white;"  href="product/<?php echo $product_cart['id'] . '-' . slug($product_cart['name']); ?>"><?php echo $product_cart['name'] ?><br><span class="amount"><strong>
																	...
																	<td class="product-actions">
																		<a  style="color: white;"  title="Remove this item" class="remove" href="cart/delete/<?php echo $product_cart['id']; ?>">
