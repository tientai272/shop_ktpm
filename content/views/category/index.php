                            ...
                            <li class="col-md-4 col-sm-6 col-xs-12 product">
                                ...
                                <span class="product-thumb-info">
                                    ...
                                    <a href="product/<?php echo $product['id']; ?>-<?php echo $product['slug']; ?>">
                                        <span class="product-thumb-info-image">
                                            <span class="product-thumb-info-act">
                                                <span class="product-thumb-info-act-left"><em>Lượt xem: <?php echo $product['totalView']; ?></em></span>
                                    ...
                                    <span class="product-thumb-info-content">
                                        <a href="product/<?php echo $product['id']; ?>-<?php echo $product['slug']; ?>">
                                        <h4 title="<?php echo $product['product_name']; ?>"><?php if (strlen($product['product_name']) > 20) echo substr($product['product_name'], 0, 20) . '...';
