...
function feedback_add()
{
    ...
    echo "<div style='padding-top: 200' class='container'><div style='text-align: center;' class='alert alert-success'><strong>Done!</strong> Thư phản hồi của bạn đã được gửi đến hệ thống của shop. Cảm ơn bạn đã gửi lại phải hồi về shop. <br><br>Hãy đến <a href='index.php'>Trang chủ</a></div></div>";
    require('content/views/feedback/result.php');
    exit;
}
