                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if(isset($comment_new)){ echo get_time($comment_new['createDate'], gmdate('Y:m:d H:i:s', time() + 7 * 3600));}else{ echo 'Không có bình luận mới'; }  ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  if(isset($page_new)) { echo get_time($page_new['post_date'], gmdate('Y:m:d H:i:s', time() + 7 * 3600)); } else{ echo 'Không có trang mới'; } ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php if(isset($post_new)){ echo get_time($post_new['post_date'], gmdate('Y:m:d H:i:s', time() + 7 * 3600)); } else { echo 'Không có bài viết mới'; } ?></td>
                                                </tr>
                                                <tr>
