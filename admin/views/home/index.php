    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Dashboard</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php"><i class="zmdi zmdi-home"></i> KTPM</a></li>
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon money">
                        <div class="body">
                            <h6 style="color: #358e9d;font-weight: 900;">Tổng tiền ( VND )</h6>
                            <h2 ><?= $total_prices_net ?> <small class="info">Dự kiến - COD: <?= $total_cod_net ?> | VNPAY: <?= $total_vnpay_net ?></small></h2>
                            <h2><?= $total_prices_gross ?> <small class="info">Thực nhận - COD: <?= $total_cod_gross ?> | VNPAY: <?= $total_vnpay_gross ?></small></h2>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon traffic">
                        <div class="body">
                            <h6 style="color: #358e9d;font-weight: 900;">Tổng trang và bài viết</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon sales">
                        <div class="body">
                            <h6 style="color: #358e9d;font-weight: 900;">Tổng đơn hàng</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon email">
                        <div class="body">
                            <h6 style="color: #358e9d;font-weight: 900;">Tổng phản hồi</h6>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card widget_2 big_icon domains">
                        <div class="body">
                            <h6 style="color: #358e9d;font-weight: 900;">Tổng Comment</h6>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($order_new && isset($order_new['post_date'])) {
                                                                echo get_time($order_new['post_date'], gmdate('Y:m:d H:i:s', time() + 7 * 3600));
                                                            } else {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <?php if ($comment_new && isset($comment_new['post_date'])) {
                                                                echo get_time($comment_new['post_date'], gmdate('Y:m:d H:i:s', time() + 7 * 3600));
                                                            } else {
                                                                echo 'Không có dữ liệu';
                                                            }
                                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($page_new && isset($page_new['post_date'])) {
                                                                echo get_time($page_new['post_date'], gmdate('Y:m:d H:i:s', time() + 7 * 3600));
                                                            } else {
                                                                echo 'Không có dữ liệu';
                                                            }
                                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($post_new && isset($post_new['post_date'])) {
                                                                echo get_time($post_new['post_date'], gmdate('Y:m:d H:i:s', time() + 7 * 3600));
                                                            } else {
                                                                echo 'Không có dữ liệu';
                                                            }
                                                        ?>
