                        ...
                        <ul class="menu list-unstyled">
                            ...
                            <li>
                                <a href="admin.php?controller=order&action=order-noprocess">
                                    ...
                                    <div class="menu-info">
                                        <?php
                                            if(!isset($total_order_noprosess) || !isset($order_new)) : ?>
                            ...
                            <li>
                                <a href="admin.php?controller=order&action=order-cancell">
                                    ...
                                    <div class="menu-info">
                                        <?php
                                        if(!isset($order_cancell)) : ?>
                                            <h4>Có 0 Đơn bị hủy</h4>
                                        <?php else : ?>
                            ...
                            <li>
                                <a href="admin.php?controller=comment&action=pending">
                                    ...
                                    <div class="menu-info">
                                        <?php
                                        if(isset($comment_new)) : ?>
                                            <h4><b><?= $comment_new['author'] ?></b> vừa bình luận</h4>
                                            <p><i class="zmdi zmdi-time"></i> <?= get_time($comment_new['createDate'], gmdate('Y:m:d H:i:s', time() + 7 * 3600)) ?> </p> </p>
                                        <?php else : ?>
                                            <h4></b>Không có bình luận mới</h4>
                                        <?php endif; ?>
                                    </div>
                                </a>
                            </li>
