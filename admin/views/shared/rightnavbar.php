                    ...
                    <li class="body">
                        <ul class="menu list-unstyled">
                            ...
                            <a href="javascript:void(0);">
                                ...
                                <div class="menu-info">
                                    <?php if (isset($users_online_total)) : ?>
                                        <h4>Có <?=  $users_online_total ?> người dùng đang truy cập</h4>
                                    <?php else: ?>
                                        <h4>Có 0 người dùng đang truy cập</h4>
                                    <?php endif; ?>
                                </div>
                            </a>
                             </li>
                             <li>
                                <a href="admin.php?controller=user&action=listall">
                                    ...
                                    <div class="menu-info">
                                        ...
                                        <?php else: ?>
                                            <h4>0 New Members joined 7 day</h4>
                                        <?php endif; ?>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a href="admin.php?controller=order&action=order-noprocess">
                                    ...
                                    <div class="menu-info">
                                        <?php if (isset($total_order_noprosess)) : ?>
                            ...
                            <li>
                                    <a href="admin.php?controller=order&action=order-cancell">
                                        ...
                                        <div class="menu-info">
                                            <?php if (isset($total_order_cancell) && isset($order_cancell)) : ?>
                                                <h4><?= $total_order_cancell ?> Đơn hàng bị hủy</h4>
                                                <p><i class="zmdi zmdi-time"></i> <?= get_time($order_cancell['editTime'], gmdate('Y:m:d H:i:s', time() + 7 * 3600)) ?> </p>
                                            <?php else: ?>
                                                <h4>0 Đơn hàng bị hủy</h4>
                                            <?php endif; ?>
                                        </div>
                                    </a>
                            </li>
